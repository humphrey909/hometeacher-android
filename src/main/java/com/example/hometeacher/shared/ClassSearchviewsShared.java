...
public class ClassSearchviewsShared extends SharedModel implements Serializable {
   // ArrayList<ArrayList<String>> AccountList = new ArrayList<ArrayList<String>>();
    ...
    public ClassSearchviewsShared(Context mContext) {
        this.oContext = mContext; //부모클래스에 전달

        dbname = "SearchClassViews"; //db name 지정
    ...
    public String SaveViewsobject(String uid){
        //Log.d("uid--------------------------------!", uid);

        ArrayList<String> accountdata = new ArrayList<>();
        accountdata.add(uid); //커플 고유번호
