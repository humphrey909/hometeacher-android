...
public class CurrentSearchCharShared extends SharedModel implements Serializable {
   // ArrayList<ArrayList<String>> AccountList = new ArrayList<ArrayList<String>>();
    ...
    public CurrentSearchCharShared(Context mContext) {
        this.oContext = mContext; //부모클래스에 전달

        dbname = "CurrentSearchChar"; //db name 지정
