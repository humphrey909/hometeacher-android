...
public class MyclassProblemwrite extends AppCompatActivity {
    Context oContext;
    Activity oActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myclass_problemadd);
    ...
    public void division() {
        ...
        roomidx = intent.getExtras().getString("rid"); // 1 추가, 2 수정
                ...
                case REQUEST_TAKE_PHOTO:
                    if (resultCode == RESULT_OK) {
                        ...
                        CropImage.activity(uridata).setGuidelines(CropImageView.Guidelines.ON)  // 크롭 위한 가이드 열어서 크롭할 이미지 받아오기
                                ...
                                .start(MyclassProblemwrite.this);
                    }
                    break;
...
//                            }
                            ...
                            if (clipData.getItemCount() > 10){
                                Toast.makeText(MyclassProblemwrite.this, "사진은 10개까지 선택가능 합니다.", Toast.LENGTH_SHORT).show();
                                return;
                            }   // 멀티 선택에서 하나만 선택했을 경우
                        ...
                        if(imguploadlist_uri.size() == 10){
                            Toast.makeText(MyclassProblemwrite.this, "사진 갯수 10개를 초과하였습니다.", Toast.LENGTH_SHORT).show();
                        }
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, retrofit2.Response<String> response) {
                if (response.isSuccessful()) {
                    ...
                    if (urlget2.equals("1")) { //과제 저장하기
                        Log.d("onResponse ? ", "과제 저장하기 : " + resultlist);
...
//                        oActivity.finish();
                    ...
                    }else if(urlget2.equals("2")){ //과제 수정하기
                        Log.d("onResponse ? ", "과제 수정하기 : " + resultlist);

                        finish();
                    }else if(urlget2.equals("3")){ //과제 정보 가져오기
                        ...
                        try {
                            ...
                            Log.d("onResponse ? ", "과제 정보 가져오기 : all" + String.valueOf(Problemlist)); //info
    ...
    public void SetProbleminfo(ArrayList<JSONObject> ProblemInfojsonarray) throws JSONException {
        ...
        documentedit.setText(String.valueOf(ProblemInfojsonarray.get(0).get("problemdocu")));
...
//        Imagerecycle(imguploadlist_uri);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.completebtn:
                ...
                if(!String.valueOf(documentedit.getText()).equals("")) {
                    ...
                    RequestBody problemdocu = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(documentedit.getText()));
                    requestMap.put("problemdocu", problemdocu);
                    ...
                    if(Selecttype == 1) { //추가
                        ...
                        call = retrofitService.problemadd(
                        ...
                        RequestBody pid = RequestBody.create(MediaType.parse("text/plain"), Selectpid);
                        ...
                        call = retrofitService.problemedit(
    ...
    public void GetProbleminfo() {
        ...
        //보낼값
        HashMap<String, RequestBody> requestMap = new HashMap<>();
        RequestBody pid = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(Selectpid));
        requestMap.put("pid", pid);
