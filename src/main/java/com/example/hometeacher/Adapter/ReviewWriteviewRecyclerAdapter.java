...
public class ReviewWriteviewRecyclerAdapter extends RecyclerView.Adapter<ReviewWriteviewRecyclerAdapter.ViewHolder> {
    Context oContext;
    Activity oActivity;
    ...
    // 리스너 객체 참조를 저장하는 변수
    private ReviewWriteviewRecyclerAdapter.OnItemClickListener mListener = null ;
    ...
    public ReviewWriteviewRecyclerAdapter(Context context, Activity activity){
        oContext = context;
        oActivity = activity;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.profilerewriteitem, parent, false);
...
//
            reviewitem = (LinearLayout) itemView.findViewById(R.id.reviewitem);
