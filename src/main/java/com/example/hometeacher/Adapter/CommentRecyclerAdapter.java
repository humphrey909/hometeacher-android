...
public class CommentRecyclerAdapter extends RecyclerView.Adapter<CommentRecyclerAdapter.ViewHolder> {
    ...
    // 리스너 객체 참조를 저장하는 변수
    private CommentRecyclerAdapter.OnItemClickListener mListener = null ;
    ...
    public CommentRecyclerAdapter(Context context, Activity activity){
        oContext = context;
        oActivity = activity;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        TextView documentinfo, writeinfo, timeinfo, likenum, commentnestednum;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            if(type == 1) { // 댓글리스트
                //답글쓰기 버튼
                commentnestedimg.setOnClickListener(new View.OnClickListener() {
                    @Override
